...
/* harmony export (immutable) */ __webpack_exports__["b"] = rankdBGdt;
...
class Bubble {
    ...
    update(target, type, x, y, units, round, format) {
        ...
        if (round) {
            y = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* round */](y, round);
        }
...
$(document).ready(() => {
    ...
    // Generate bubble
    const _Bubble = new __WEBPACK_IMPORTED_MODULE_2__modules_bubble_bubble__["a" /* Bubble */]();
...
class Dash {
    ...
    update() {
        ...
        // Read lastest infos
        const lastBG = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* round */](BGs.eq(-1).attr("y"));
        const lastBGType = BGs.eq(-1).attr("class");
        const TB = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* round */](TBs.eq(-2).attr("y"));
        const dBG = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* round */](BGs.eq(-1).attr("y") - BGs.eq(-2).attr("y"));
        const dt = (parseInt(BGs.eq(-1).attr("x")) -
                    parseInt(BGs.eq(-2).attr("x"))) / 1000 / 60 / 60; // (h)

        // Compute latest infos
        const dBGdt = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* round */](dBG / dt);
        const arrow = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* rankdBGdt */](dBGdt, this.dBGdtScale);
