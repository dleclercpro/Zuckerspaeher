...
class Bubble {
    ...
    update(target, type, units, round, format) {
        ...
        if (format) {
            x = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["a" /* convertTime */](x, format);
        }

        // Round info if desired
        if (round) {
            y = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](y, round);
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_bubble_bubble__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_dash_dash__ = __webpack_require__(4);
...
$(document).ready(() => {
    ...
    // Generate dash
    const _Dash = new __WEBPACK_IMPORTED_MODULE_3__modules_dash_dash__["a" /* Dash */]([1, 2, 3, 4]);

    // Generate BG graph
    const _GraphBG = new __WEBPACK_IMPORTED_MODULE_4__modules_graph_graph__["a" /* GraphBG */]("BG");

    // Generate I graph
    const _GraphI = new __WEBPACK_IMPORTED_MODULE_4__modules_graph_graph__["b" /* GraphI */]("I");
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bubble_bubble__ = __webpack_require__(1);
// Imports
...
class Graph {
    ...
    buildAxis(z, z0, dz, dZ, label, format) {
        ...
        if (format) {
            ...
            for (let tick of axis.children()) {
                ...
                // Convert time
                t = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["a" /* convertTime */](t, format);
    ...
    showBars(type, units, round, y0) {
        ...
        // Get bar styles
        const thicknessBorder = parseFloat(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* first */](bars).css("border-top-width")) ||
                                parseFloat(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* first */](bars).css("border-bottom-width"));
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["e" /* last */](graph.children()).css("margin-right", W);
        ...
        for (let i = 0; i < n; i++) {
            ...
            if (y[i] > 0) {
                if (i != 0 && y[i] > y[i - 1]) {
                    __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* first */](bar.children()).css("height", y[i] - y[i - 1]);
                }

                if (i != n && y[i] > y[i + 1]) {
                    __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["e" /* last */](bar.children()).css("height", y[i] - y[i + 1]);
                }
            }
            // Lower than baseline
            else if (y[i] < 0) {
                if (i != 0 && y[i] < y[i - 1]) {
                    __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* first */](bar.children()).css("height", Math.abs(y[i] - y[i - 1]));
                }

                if (i != n && y[i] < y[i + 1]) {
                    __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["e" /* last */](bar.children()).css("height", Math.abs(y[i] - y[i + 1]));
                }
            }
            ...
            if (i != 0 && (y[i - 1] < 0 && y[i] > 0 || y[i - 1] > 0 && y[i] < 0)) {
                __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* first */](bar.children()).css("height", "100%");
                // From 1 to -1
            }
            else if (i != n && (y[i + 1] < 0 && y[i] > 0 || y[i + 1] > 0 && y[i] < 0)) {
                __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["e" /* last */](bar.children()).css("height", "100%");
            }
