...
$(document).ready(() => {
    ...
    const now = new Date(),
          ...
          dBGdtScale = __WEBPACK_IMPORTED_MODULE_1__lib__["d" /* mirror */]([0.1, 0.3]).map(x => __WEBPACK_IMPORTED_MODULE_1__lib__["g" /* round */](x * n, 1)); // (mmol/L/h)

    // Get data
    const BGs = __WEBPACK_IMPORTED_MODULE_1__lib__["b" /* getData */]("reports/BG.json"),
    ...
    // Generate BG graph
    const graphBG = new __WEBPACK_IMPORTED_MODULE_4__modules_graph_graphBG__["a" /* GraphBG */]();

    // Generate I graph
    const graphI = new __WEBPACK_IMPORTED_MODULE_5__modules_graph_graphI__["a" /* GraphI */]();
    ...
    // Generate dash
    const dash = new __WEBPACK_IMPORTED_MODULE_3__modules_dash_dash__["a" /* Dash */](x0, BGScale, dBGdtScale);
