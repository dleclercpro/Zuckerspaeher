...
class Dash {
    ...
    updateBG(data) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastT, this.now, dtMaxBG, () => {
            ...
            __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastlastT, lastT, dtMaxdBGdt, () => {
                ...
                this.dBG.find(".value").text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](dBG, 1).toFixed(1));
                this.dBGdt.find(".value").text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](dBGdt, 1).toFixed(1));
    ...
    updateNB(data) {
        ...
        const lastT = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](t),
              lastNB = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](NBs);
    ...
    updatePumpReservoirLevel(data, scale) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastT, this.now, dtMax, () => {
            ...
            // Rank level
            this.reservoir.addClass(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rank */](lastLevel, scale));
