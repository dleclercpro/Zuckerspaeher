...
/* harmony export (immutable) */ __webpack_exports__["d"] = mirror;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = rankBG;
...
/* harmony export (immutable) */ __webpack_exports__["f"] = rankdBGdt;
...
class Graph {
    ...
    spaceBars(type) {
        ...
        // Get last bar
        const lastBar = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* last */](this.bars[type]);
...
$(document).ready(() => {
    ...
    const config = {
        ...
        yI: __WEBPACK_IMPORTED_MODULE_1__lib__["d" /* mirror */]([2, 4], true), // U/h
        BGScale: [3.8, 4.2, 7.0, 9.0], // (mmol/L)
        dBGdtScale: __WEBPACK_IMPORTED_MODULE_1__lib__["d" /* mirror */]([0.1, 0.3]).map(x => __WEBPACK_IMPORTED_MODULE_1__lib__["g" /* round */](x * 60 / 5, 1)), // (mmol/L/h)
    };
    ...
    // Get data
    const data = {
        BGs: __WEBPACK_IMPORTED_MODULE_1__lib__["b" /* getData */]("reports/BG.json"),
        TBs: __WEBPACK_IMPORTED_MODULE_1__lib__["b" /* getData */]("reports/treatments.json", ["Net Basals"]),
        Bs: __WEBPACK_IMPORTED_MODULE_1__lib__["b" /* getData */]("reports/treatments.json", ["Boluses"]),
        IOBs: __WEBPACK_IMPORTED_MODULE_1__lib__["b" /* getData */]("reports/treatments.json", ["IOB"]),
        pumpReservoirLevels: __WEBPACK_IMPORTED_MODULE_1__lib__["b" /* getData */]("reports/history.json", ["Pump", "Reservoir Levels"]),
        pumpBatteryLevels: __WEBPACK_IMPORTED_MODULE_1__lib__["b" /* getData */]("reports/history.json", ["Pump", "Battery Levels"]),
        cgmBatteryLevels: __WEBPACK_IMPORTED_MODULE_1__lib__["b" /* getData */]("reports/history.json", ["CGM", "Battery Levels"]),
    };
...
class User {
    ...
    updatePumpBatteryLevel(data) {
        ...
        const lastT = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* last */](t),
              lastLevel = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* last */](levels);
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastT, this.now, dtMax, () => {
		    ...
		    const level = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */]((lastLevel - minLevel) / (maxLevel - minLevel) * 100, 0);
    ...
    updateCGMBatteryLevel(data) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastT, this.now, dtMax, () => {
		    ...
		    // Round level (%)
		    const level = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](lastLevel, 0);
...
class Dash {
    ...
    updateBG(data) {
        ...
        const lastT = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* last */](t),
              lastBG = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* last */](BGs),
              lastlastT = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* last */](t, 2),
              lastlastBG = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* last */](BGs, 2);
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastT, this.now, dtMaxBG, () => {
            ...
            // Compute BG rank
            const BGRank = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["e" /* rankBG */](lastBG, this.BGScale);

            // Update BG
            this.BG.text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](lastBG));
            ...
            __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastlastT, lastT, dtMaxdBGdt, () => {
                ...
                const trend = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rankdBGdt */](dBGdt, this.dBGdtScale);

                // Update dBG and dBG/dt
                this.dBG.find(".value").text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](dBG));
                this.dBGdt.find(".value").text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](dBGdt));
    ...
    updateNB(data) {
        ...
        const lastT = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* last */](t),
              lastTB = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* last */](TBs);
    ...
    updateIOB(data) {
        ...
        const lastT = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* last */](t),
              lastIOB = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* last */](IOBs);
...
class GraphBG extends __WEBPACK_IMPORTED_MODULE_1__graph__["a" /* Graph */] {
    ...
    color (scale) {
        ...
        for (let dot of this.dots["BG"]) {
            ...
            dot.self.addClass(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["e" /* rankBG */](dot.y, scale));
        }
    }
}
...
class Bubble {
    ...
    update(target) {
        ...
        if (this.format != null) {
            ...
            // Format
            this.x = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["a" /* formatTime */](this.x, this.format);
        }
        ...
        if (this.round != null) {
            ...
            // Round
            this.y = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](this.y, this.round);
        }
...
class Tick {
    ...
    format(f) {
        ...
        this.fill(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["a" /* formatTime */](this.value, f));
    }
