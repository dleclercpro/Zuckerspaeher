...
/* harmony export (immutable) */ __webpack_exports__["a"] = filterString;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = mirror;
...
const verifyValidity = (t0, t1, dt, callback) => {
...
/* harmony export (immutable) */ __webpack_exports__["h"] = verifyValidity;
...
/* harmony export (immutable) */ __webpack_exports__["f"] = rank;
...
let
    ...
    yI = __WEBPACK_IMPORTED_MODULE_0__lib__["e" /* mirror */]([2, 4], true), // U/h
    BGScale = {
    ...
    dBGdtScale = {
      ranks: ["↓↓", "↓", "↘", "→", "↗", "↑", "↑↑"],
      limits: __WEBPACK_IMPORTED_MODULE_0__lib__["e" /* mirror */]([0.1, 0.3, 0.5]), // (mmol/L/5m)
    },
    batteryLevelScale = {
...
dx *= 60 * 60 * 1000; // (ms)
dX *= 60 * 60 * 1000; // (ms)
dBGdtScale.limits = dBGdtScale.limits.map(x => __WEBPACK_IMPORTED_MODULE_0__lib__["g" /* round */](x * 60 / 5, 1)); // (mmol/L/h)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bubble_bubble__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__axis_axis__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__corner_corner__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__inner_inner__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__inner_dot_dot__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__inner_bar_bar__ = __webpack_require__(14);
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class Graph {
    ...
    spaceBars(type) {
        ...
        // Get last bar
        const lastBar = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](this.bars[type]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_user_user__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_dash_dash__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_graph_graphBG__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__modules_graph_graphI__ = __webpack_require__(15);
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
const build = (elements, data, now) => {
    ...
    graphBG.color(__WEBPACK_IMPORTED_MODULE_2__config__["BGScale"]);

    // Update dash
    dash.updateBG(BGs);
    dash.updateNB(TBs);
    dash.updateIOB(IOBs);
    dash.updatePumpReservoirLevel(pumpReservoirLevels, __WEBPACK_IMPORTED_MODULE_2__config__["reservoirLevelScale"]);

    // Update user
    user.updatePumpBatteryLevel(pumpBatteryLevels, __WEBPACK_IMPORTED_MODULE_2__config__["batteryLevelScale"]);
    user.updateCGMBatteryLevel(cgmBatteryLevels, __WEBPACK_IMPORTED_MODULE_2__config__["batteryLevelScale"]);
};
...
$(document).ready(() => {
    ...
    // Generate elements
    const elements = {
        graphBG: new __WEBPACK_IMPORTED_MODULE_5__modules_graph_graphBG__["a" /* GraphBG */](),
        graphI: new __WEBPACK_IMPORTED_MODULE_6__modules_graph_graphI__["a" /* GraphI */](),
    ...
    // Get data
    const data = {
        BGs: __WEBPACK_IMPORTED_MODULE_1__lib__["c" /* getData */]("reports/BG.json"),
        TBs: __WEBPACK_IMPORTED_MODULE_1__lib__["c" /* getData */]("reports/treatments.json", ["Net Basals"]),
        Bs: __WEBPACK_IMPORTED_MODULE_1__lib__["c" /* getData */]("reports/treatments.json", ["Boluses"]),
        IOBs: __WEBPACK_IMPORTED_MODULE_1__lib__["c" /* getData */]("reports/treatments.json", ["IOB"]),
        pumpReservoirLevels: __WEBPACK_IMPORTED_MODULE_1__lib__["c" /* getData */]("reports/history.json", ["Pump", "Reservoir Levels"]),
        pumpBatteryLevels: __WEBPACK_IMPORTED_MODULE_1__lib__["c" /* getData */]("reports/history.json", ["Pump", "Battery Levels"]),
        cgmBatteryLevels: __WEBPACK_IMPORTED_MODULE_1__lib__["c" /* getData */]("reports/history.json", ["CGM", "Battery Levels"]),
    };
...
class User {
    ...
    updatePumpBatteryLevel(data, scale) {
        ...
        const lastT = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](t),
              lastLevel = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](levels);

        // Define max validity time (ms)
        const dtMax = 60 * 60 * 1000;

        // If last level found is still valid
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastT, this.now, dtMax, () => {
		    ...
		    const level = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */]((lastLevel - minLevel) / (maxLevel - minLevel) * 100);

            // Rank level
            this.pumpBattery.addClass(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rank */](level, scale));
    ...
    updateCGMBatteryLevel(data, scale) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastT, this.now, dtMax, () => {
		    ...
		    // Round level (%)
		    const level = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](lastLevel);

		    // Rank level
            this.cgmBattery.addClass(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rank */](level, scale));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_js_config__ = __webpack_require__(1);
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class Dash {
    ...
    updateBG(data) {
        ...
        const lastT = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](t),
              lastBG = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](BGs),
              lastlastT = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](t, 2),
              lastlastBG = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](BGs, 2);
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastT, this.now, dtMaxBG, () => {

            // Compute BG rank
            const BGRank = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rank */](lastBG, __WEBPACK_IMPORTED_MODULE_1__assets_js_config__["BGScale"]);

            // Update BG
            this.BG.text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](lastBG, 1));

            // Add rank
            this.BG.addClass(BGRank);

            // If second last BG found is still valid
            __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastlastT, lastT, dtMaxdBGdt, () => {
                ...
                const trend = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rank */](dBGdt, __WEBPACK_IMPORTED_MODULE_1__assets_js_config__["dBGdtScale"]);

                // Update dBG and dBG/dt
                this.dBG.find(".value").text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](dBG, 1));
                this.dBGdt.find(".value").text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](dBGdt, 1));
    ...
    updateNB(data) {
        ...
        const lastT = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](t),
              lastTB = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](TBs);
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastT, this.now, dtMax, () => {
            ...
            // Update TB
            this.netBasal.find(".value").text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](lastTB, 2));
    ...
    updateIOB(data) {
        ...
        const lastT = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](t),
              lastIOB = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](IOBs);
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastT, this.now, dtMax, () => {
            ...
            // Update TB
            this.IOB.find(".value").text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](lastIOB, 1));
        });
    }
    ...
    updatePumpReservoirLevel(data, scale) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* verifyValidity */](lastT, this.now, dtMax, () => {
            ...
            // Round level (U)
            const level = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](lastLevel, 1);

            // Rank level
            this.reservoir.addClass(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rank */](level, scale));
...
class GraphBG extends __WEBPACK_IMPORTED_MODULE_1__graph__["a" /* Graph */] {
    ...
    color (scale) {
        ...
        for (let dot of this.dots["BG"]) {
            ...
            dot.self.addClass(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rank */](dot.y, scale));
        }
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = GraphBG;
...
class Bubble {
    ...
    update(target) {
        ...
        this.type = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["a" /* filterString */](target.self.attr("class"), "mod-");
        ...
        if (this.format != null) {
            ...
            // Format
            this.x = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* formatTime */](this.x, this.format);
        }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tick_tick__ = __webpack_require__(10);
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class Tick {
    ...
    format(f) {
        ...
        this.fill(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* formatTime */](this.value, f));
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__graph__ = __webpack_require__(2);
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class GraphI extends __WEBPACK_IMPORTED_MODULE_0__graph__["a" /* Graph */] {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = GraphI;
