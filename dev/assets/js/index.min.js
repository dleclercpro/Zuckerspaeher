...
/* harmony export (immutable) */ __webpack_exports__["c"] = indexSort;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_graph_axis__ = __webpack_require__(1);
...
$(document).ready(() => {
    ...
    // Get data
    let BGs = __WEBPACK_IMPORTED_MODULE_1__lib__["b" /* getData */]("reports/BG.json", false, "YYYY.MM.DD - HH:MM:SS"),
        TBs = __WEBPACK_IMPORTED_MODULE_1__lib__["b" /* getData */]("reports/treatments.json", "Net Basals", "YYYY.MM.DD - HH:MM:SS"),
        Bs = __WEBPACK_IMPORTED_MODULE_1__lib__["b" /* getData */]("reports/treatments.json", "Boluses", "YYYY.MM.DD - HH:MM:SS");
...
class Dash {
    ...
    update() {
        ...
        // Read lastest infos
        const lastBG = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](BGs.eq(-1).attr("y"));
        const lastBGType = BGs.eq(-1).attr("class");
        const TB = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](TBs.eq(-2).attr("y"));
        const dBG = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](BGs.eq(-1).attr("y") - BGs.eq(-2).attr("y"));
        const dt = (parseInt(BGs.eq(-1).attr("x")) -
                    parseInt(BGs.eq(-2).attr("x"))) / 1000 / 60 / 60; // (h)

        // Compute latest infos
        const dBGdt = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](dBG / dt);
        const arrow = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rankdBGdt */](dBGdt, this.dBGdtScale);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__axis__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__dot__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__bar__ = __webpack_require__(11);
// Imports
...
class Graph {
    ...
    buildAxis(type, z0, dz, dZ, z = [], f = false, offset = 0) {
        ...
        // Create axis object
        const axis = new __WEBPACK_IMPORTED_MODULE_4__axis__["a" /* Axis */](type);
    ...
    buildDots(type, units, round, format, data) {
        ...
        for (let i = 0; i < x.length; i++) {
            ...
            // Generate new dot
            let dot = new __WEBPACK_IMPORTED_MODULE_5__dot__["a" /* Dot */](type, units, round, format);
    ...
    showBars(type, units, round, y0) {
        ...
        const dW = this.xMax - __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](x);
...
class GraphBG extends Graph {
    ...
    color (BGScale) {
        ...
        for (let dot of this.dots["BG"]) {
            ...
            dot.self.addClass(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["e" /* rankBG */](dot.y, BGScale));
        }
    }
}
...
class GraphI extends Graph {
    ...
    profileTBs (data, dt = 5 * 60 * 1000) {
        ...
        [t, net] = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* indexSort */](t, net);
...
class Bubble {
    ...
    update(target) {
        ...
        if (this.format != null) {
            this.x = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["a" /* convertTime */](this.x, this.format);
        }
