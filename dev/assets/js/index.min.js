...
/* harmony export (immutable) */ __webpack_exports__["c"] = rankdBGdt;
...
class Bubble {
    ...
    update(target, type, units, round, format) {
        ...
        if (round) {
            y = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* round */](y, round);
        }
...
class Dash {
    ...
    update() {
        ...
        // Read lastest infos
        const lastBG = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* round */](BGs.eq(-1).attr("y"));
        const lastBGType = BGs.eq(-1).attr("class");
        const TB = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* round */](TBs.eq(-2).attr("y"));
        const dBG = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* round */](BGs.eq(-1).attr("y") - BGs.eq(-2).attr("y"));
        const dt = (parseInt(BGs.eq(-1).attr("x")) -
                    parseInt(BGs.eq(-2).attr("x"))) / 1000 / 60 / 60; // (h)

        // Compute latest infos
        const dBGdt = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* round */](dBG / dt);
        const arrow = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["c" /* rankdBGdt */](dBGdt, this.dBGdtScale);
