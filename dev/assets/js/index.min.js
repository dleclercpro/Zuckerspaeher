...
/* harmony export (immutable) */ __webpack_exports__["a"] = convertTime;
...
/* harmony export (immutable) */ __webpack_exports__["d"] = indexSort;
...
/* unused harmony export decodeEntity */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_dash_dash__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_graph_axis__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_graph_graph__ = __webpack_require__(6);
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
$(document).ready(() => {
    ...
    // Generate dash
    const dash = new __WEBPACK_IMPORTED_MODULE_2__modules_dash_dash__["a" /* Dash */]([1, 2, 3, 4]);

    // Generate BG graph
    const graphBG = new __WEBPACK_IMPORTED_MODULE_4__modules_graph_graph__["a" /* GraphBG */]("BG");

    // Generate I graph
    const graphI = new __WEBPACK_IMPORTED_MODULE_4__modules_graph_graph__["b" /* GraphI */]("I");

    // Generate axes
    graphI.xAxis = new __WEBPACK_IMPORTED_MODULE_3__modules_graph_axis__["a" /* Axis */]("x");
    graphI.xAxis.generate(x0, dx, dX)
    graphI.xAxis.build("HH:MM", 1);
    graphI.yAxis = new __WEBPACK_IMPORTED_MODULE_3__modules_graph_axis__["a" /* Axis */]("y");
    graphI.yAxis.define(yI);
    graphI.yAxis.build();
    graphBG.yAxis = new __WEBPACK_IMPORTED_MODULE_3__modules_graph_axis__["a" /* Axis */]("y");
    ...
    // Get data
    let BGs = __WEBPACK_IMPORTED_MODULE_1__lib__["c" /* getData */]("reports/BG.json", false, "YYYY.MM.DD - HH:MM:SS"),
        TBs = __WEBPACK_IMPORTED_MODULE_1__lib__["c" /* getData */]("reports/treatments.json", "Net Basals", "YYYY.MM.DD - HH:MM:SS"),
        Bs = __WEBPACK_IMPORTED_MODULE_1__lib__["c" /* getData */]("reports/treatments.json", "Boluses", "YYYY.MM.DD - HH:MM:SS");
...
class Dash {
    ...
    update() {
        ...
        // Read lastest infos
        const lastBG = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](BGs.eq(-1).attr("y"));
        const lastBGType = BGs.eq(-1).attr("class");
        const TB = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](TBs.eq(-2).attr("y"));
        const dBG = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](BGs.eq(-1).attr("y") - BGs.eq(-2).attr("y"));
        const dt = (parseInt(BGs.eq(-1).attr("x")) -
                    parseInt(BGs.eq(-2).attr("x"))) / 1000 / 60 / 60; // (h)

        // Compute latest infos
        const dBGdt = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](dBG / dt);
        const arrow = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* rankdBGdt */](dBGdt, this.dBGdtScale);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tick__ = __webpack_require__(5);
// Imports
...
class Axis {
    ...
    build(f = false, offset = 0) {
        ...
        for (let i = 0; i < this.z.length - 1; i++) {
            ...
            // Generate new tick
            const tick = new __WEBPACK_IMPORTED_MODULE_0__tick__["a" /* Tick */](this.type);
...
class Tick {
    ...
    format(f) {
        ...
        this.fill(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["a" /* convertTime */](this.value, f));
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__inner__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__corner__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__dot__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__bar__ = __webpack_require__(11);
// Imports
...
class Graph {
    ...
    constructor(type) {
        ...
        this.inner = new __WEBPACK_IMPORTED_MODULE_2__inner__["a" /* Inner */]();

        // Give graph a corner section
        this.corner = new __WEBPACK_IMPORTED_MODULE_3__corner__["a" /* Corner */]();
    ...
    buildDots(type, data) {
        ...
        for (let i = 0; i < x.length; i++) {
            ...
            // Generate new dot
            let dot = new __WEBPACK_IMPORTED_MODULE_4__dot__["a" /* Dot */](this.type);
    ...
    showDots(type, units, round, y0) {
        ...
        // Get dot styles
        const radiusDot = parseFloat($(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* first */](dots)).outerWidth()) / 2;
        const thicknessXTick = parseFloat($(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* first */](xTicks)).css("border-left-width") ||
                                          $(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* first */](xTicks)).css("border-right-width"));
        const thicknessYTick = parseFloat($(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* first */](yTicks)).css("border-top-width") ||
                                          $(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["b" /* first */](yTicks)).css("border-bottom-width")); // FIXME
    ...
    showBars(type, units, round, y0) {
        ...
        const dW = this.xMax - __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["e" /* last */](x);
...
class GraphBG extends Graph {
    ...
    colorBGs (BGScale) {
        ...
        for (let i = 0; i < BGs.length; i++) {
            ...
            BGs.eq(i).addClass(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rankBG */](BG, BGScale));
        }
    }
}
...
class GraphI extends Graph {
    ...
    profileTBs (data, dt = 5 * 60 * 1000) {
        ...
        [t, net] = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* indexSort */](t, net);
...
/* harmony export (immutable) */ __webpack_exports__["b"] = GraphI;
...
class Bubble {
    ...
    update(target, type, units, round, format) {
        ...
        if (format) {
            this.x = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["a" /* convertTime */](this.x, format);
        }

        // Round info if desired
        if (round) {
            this.y = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](this.y, round);
        }
