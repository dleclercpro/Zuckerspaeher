...
/* harmony export (immutable) */ __webpack_exports__["f"] = rankBG;
...
/* harmony export (immutable) */ __webpack_exports__["g"] = rankdBGdt;
...
$(document).ready(() => {
    ...
    const config = {
        ...
        dBGdtScale: __WEBPACK_IMPORTED_MODULE_1__lib__["e" /* mirror */]([0.1, 0.3]).map(x => __WEBPACK_IMPORTED_MODULE_1__lib__["h" /* round */](x * 60 / 5, 1)), // (mmol/L/h)
    };
...
class User {
    ...
    updatePumpBatteryLevel(data) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["i" /* verifyValidity */](lastT, this.now, dtMax, () => {
		    ...
		    const level = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */]((lastLevel - minLevel) / (maxLevel - minLevel) * 100, 0);
    ...
    updateCGMBatteryLevel(data) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["i" /* verifyValidity */](lastT, this.now, dtMax, () => {
		    ...
		    // Round level (%)
		    const level = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](lastLevel, 0);
...
class Dash {
    ...
    updateBG(data) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["i" /* verifyValidity */](lastT, this.now, dtMaxBG, () => {
            ...
            // Compute BG rank
            const BGRank = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rankBG */](lastBG, this.BGScale);

            // Update BG
            this.BG.text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](lastBG));
            ...
            __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["i" /* verifyValidity */](lastlastT, lastT, dtMaxdBGdt, () => {
                ...
                const trend = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* rankdBGdt */](dBGdt, this.dBGdtScale);

                // Update dBG and dBG/dt
                this.dBG.find(".value").text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](dBG));
                this.dBGdt.find(".value").text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](dBGdt));
    ...
    updateNB(data) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["i" /* verifyValidity */](lastT, this.now, dtMax, () => {
            ...
            // Update TB
            this.netBasal.find(".value").text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](lastTB, 2));
    ...
    updateIOB(data) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["i" /* verifyValidity */](lastT, this.now, dtMax, () => {
            ...
            // Update TB
            this.IOB.find(".value").text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](lastIOB, 1));
        });
    }
    ...
    updatePumpReservoirLevel(data) {
        ...
        __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["i" /* verifyValidity */](lastT, this.now, dtMax, () => {
            ...
            // Round level (U)
            const level = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["h" /* round */](lastLevel, 1);
...
class GraphBG extends __WEBPACK_IMPORTED_MODULE_1__graph__["a" /* Graph */] {
    ...
    color (scale) {
        ...
        for (let dot of this.dots["BG"]) {
            ...
            dot.self.addClass(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rankBG */](dot.y, scale));
        }
    }
}
