...
/* harmony export (immutable) */ __webpack_exports__["d"] = rankBG;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = rankdBGdt;
...
class Dash {
    ...
    updateBG(data) {
        ...
        this.verifyValidity(lastT, this.now, dtMaxBG, () => {
            ...
            // Compute BG rank
            const BGRank = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* rankBG */](lastBG, this.BGScale);

            // Update BG
            this.BG.text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* round */](lastBG));
            ...
            this.verifyValidity(lastlastT, lastT, dtMaxdBGdt, () => {
                ...
                const trend = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["e" /* rankdBGdt */](dBGdt, this.dBGdtScale);

                // Update dBG and dBG/dt
                this.dBG.text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* round */](dBG));
                this.dBGdt.text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* round */](dBGdt));
    ...
    updateTB(data) {
        ...
        this.verifyValidity(lastT, this.now, dtMax, () => {
            ...
            // Update TB
            this.TB.text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* round */](lastTB, 2));
    ...
    updateIOB(data) {
        ...
        this.verifyValidity(lastT, this.now, dtMax, () => {
            ...
            // Update TB
            this.IOB.text(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* round */](lastIOB, 1));
        });
    }
...
class GraphBG extends __WEBPACK_IMPORTED_MODULE_1__graph__["a" /* Graph */] {
    ...
    color (scale) {
        ...
        for (let dot of this.dots["BG"]) {
            ...
            dot.self.addClass(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* rankBG */](dot.y, scale));
        }
    }
}
...
class Bubble {
    ...
    update(target) {
        ...
        if (this.round != null) {
            ...
            // Round
            this.y = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* round */](this.y, this.round);
        }
