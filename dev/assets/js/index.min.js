...
$(document).ready(() => {
    ...
    const data = {
        ...
        basal: __WEBPACK_IMPORTED_MODULE_1__lib__["c" /* getData */]("reports/pump.json", ["Basal Profile (Standard)"], "HH:MM"),
...
class Dash {
    ...
    updateBasal(data) {
        ...
        const lastT = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](t),
              lastBasal = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["d" /* last */](basals);

        // Round basal (U/h)
        const basal = __WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["g" /* round */](lastBasal, 2);
...
class Graph {
    ...
    rank(elements, type, scale) {
        ...
        for (let e of elements) {
            ...
            e.self.addClass(__WEBPACK_IMPORTED_MODULE_0__assets_js_lib__["f" /* rank */](e.y, scale));
        }
    }
